fun main(args: Array<String>) {
    ...
    val ProfessorFavorito: String = "Mariano"
    println(ProfessorFavorito)
    // tarefa 3: criar uma variavel imutavel com a idade do professor favorito e imprimir na tela
    val IdadeProfessorFavorito: Int = 30
    println(IdadeProfessorFavorito)
    ...
    println("$ProfessorFavorito tem ${IdadeProfessorFavorito + 1} anos de idade")
    ...
    if (IdadeProfessorFavorito > 30) {
        println("Está ficando coroa!")
    } else {
        println("Ainda é um jovem igual mariano!")
    }
    ...
    fun fraseProfessor(nome: String, idade: Int) {
        println("$nome tem ${idade + 1} anos de idade")
        if (idade > 30) {
            println("Está ficando coroa!")
        } else {
            println("Ainda é um jovem igual mariano!")
    ...
    // tarefa 7: declare qual o tipo correto das variaveis abaixo
                ...
                val e: Boolean = false
                val f: Char = '\n'
                var g: IntArray  = IntArray(5) // desafio!
